...
public class RandomArrayTotal {
	...
	public static double benchmark(int size, int threads) throws InterruptedException {
		int warmup = 10;
		int runs = 30;
		...
		System.out.printf("%.06f seconds average for %d numbers and %d threads%n", average, size, threads);
